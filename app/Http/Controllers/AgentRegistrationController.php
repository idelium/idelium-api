...
class AgentRegistrationController extends Controller
{
    ...
    public function register(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'identityProof' => ['sometimes', 'array'],
            'identityProof.certificateSha256' => ['sometimes', 'string', 'regex:/^[a-fA-F0-9]{64}$/'],
        ...
        $agent = DB::transaction(function () use ($request, $customer, $validated) {
            ...
            $agent->fill([
                ...
                'identityProof' => $validated['identityProof'] ?? ($agent->identityProof ?? []),
    ...
    private function agentResponse(AgentRegistration $agent): array
    {
        return [
            ...
            'identityProof' => $agent->identityProof ?? [],
